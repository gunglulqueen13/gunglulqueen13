...
1. Полный цикл бизнес-анализа: интервью со стейкхолдерами, формализация требований, проектная документация

2. Оптимизация процессов (BPMN 2.0, UML) с измеримыми результатами (сокращение времени выполнения на 20%)

3. Глубокая техническая экспертиза: SQL (сложные запросы, оконные функции), REST API, Python

4. Опыт взаимодействия с командами разработки (frontend/backend) и понимание полного цикла создания продукта

5. Визуализация данных и построение дашбордов в BI-системах

6. Технический стек, подкрепляющий аналитическую работу: SQL, Python, BPMN, UML, REST API, React.js, PostgreSQL, системы визуализации данных.
...
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/dark_soulmate13) 
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:veshapoli@gmail.com)
