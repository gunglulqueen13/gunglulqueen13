...
Выпускница Московского технического университета связи и информатики <a href="https://mtuci.ru"> с более чем 2-летним опытом в IT. Владею комплексным подходом к аналитике: от сбора требований и моделирования процессов до внедрения и мониторинга KPI.
...
Глубокая техническая экспертиза: SQL (сложные запросы, оконные функции), REST API, Python

Опыт взаимодействия с командами разработки (frontend/backend) и понимание полного цикла создания продукта

Визуализация данных и построение дашбордов в BI-системах
